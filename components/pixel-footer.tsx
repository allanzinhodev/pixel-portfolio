...
export function PixelFooter() {
  ...
  const socialLinks = [
    { icon: <YoutubeIcon size={24} />, href: "https://www.youtube.com/@allanzinhodev", label: "YouTube" },
    { icon: <GithubIcon size={24} />, href: "https://github.com/allanzinhodev", label: "GitHub" },
    { icon: <InstagramIcon size={24} />, href: "https://instagram.com/allaorodigues", label: "Instagram" },
    { icon: <LinkedinIcon size={24} />, href: "https://www.linkedin.com/in/allanzinho/", label: "LinkedIn" },
  ];
    ...
    <footer className="bg-primary/20 border-t-4 border-black mt-16 pixel-grid">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <h3 className="text-xl font-bold">AllanRodrigues</h3>
            </div>
            <p className="text-lg">
        ...
        <div className="text-center">
          <p className="text-lg">
            © {currentYear} AllanRodrigues. All rights reserved.
          </p>
